                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="tel" name="mobilenumber"
                                                                                class="form-control"
                                                                                value="{{$user[0]->buyers[0]->mobilenumber}}" />
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="landlinehome"
                                                                                ...
                                                                                value="{{$user[0]->buyers[0]->landlinehome}}" />
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="landlineoffice"
                                                                                ...
                                                                                value="{{$user[0]->buyers[0]->landlineoffice}}" />
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="tel" name="othermobile"
                                                                                ...
                                                                                value="{{$user[0]->buyers[0]->othermobile}}" />
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea name="address"
                                                                                class="form-control"
                                                                                placeholder="Address">{{$user[0]->buyers[0]->address}}</textarea>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea name="addressnew"
                                                                                class="form-control"
                                                                                placeholder="Address">{{$user[0]->buyers[0]->addressnew}}</textarea>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control"
                                                                                ...
                                                                                value="{{$user[0]->buyers[0]->landmark}}" />
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
