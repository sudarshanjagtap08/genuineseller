                ...
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        ...
                        <div class="table-wrap">
                            <form action="{{ url('profile/update/seller')}}" method="post"
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea name="address"
                                                                                class="form-control"
                                                                                placeholder="Address">{{$user[0]->sellers[0]->address}}</textarea>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea name="addressnew"
                                                                                class="form-control"
                                                                                placeholder="Address">{{$user[0]->sellers[0]->addressnew}}</textarea>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
